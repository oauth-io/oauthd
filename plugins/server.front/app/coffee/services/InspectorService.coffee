define [], () ->
	InspectorService = (UserService, ProviderService, AppService, KeysetService, OAuthIOService) ->
		console.log("|-----------------------------------------------------|\n" +
					...
					"|-----------------------------------------------------|")
		fctAvailable = ["provider.list", "user.register","user.isLogin","user.logout","user.login","user.me","app.get","app.create","app.update","app.remove","keyset.get","keyset.add","keyset.remove","contact"]
	...
	return ["UserService", "ProviderService", "AppService", "KeysetService", "OAuthIOService", InspectorService]
